...
faq_answers = ["I'm a chatbot created by Priyanshu Patra.", "I use machine learning to respond to your queries.","My purpose is to assist you in your work.","This chatbot is designed to provide mental health support, tips, and resources. It can help you manage stress, anxiety, and other common mental health concerns, but it’s not a substitute for professional therapy or medical advice",
...
def main():
    ...
    st.title("HelpMate - Wellness Companion")
    
    menu = ["Home", "Conversation History", "About"]
    choice = st.sidebar.selectbox("Menu", menu)
    
    if choice == "Home":
        st.write("Welcome to the HelpMate, we are always there to help you")
        ...
        st.write("HelpMate is a wellness companion designed to provide support, resources, and information on common mental health concerns. Our goal is to help you manage stress, anxiety, depression, and other emotional challenges in a safe and supportive environment. While HelpMate can offer guidance and encouragement, it is not a substitute for professional therapy or medical advice. If you are in crisis or experiencing severe distress, please seek help from a licensed mental health professional or contact emergency services immediately.")
        ...
        st.write("HelpMate is an intent-based chatbot designed to understand your unique mental health concerns and provide meaningful responses. Whether you’re seeking help with managing stress, coping with anxiety, navigating relationships, or improving self-care, we’re here to guide you.")
        
        st.subheader("Note:")
        st.write("While HelpMate is here to support you, it is not a substitute for professional therapy or medical intervention. If you’re experiencing severe mental health challenges or are in crisis, please reach out to a licensed mental health professional or emergency services immediately.")
